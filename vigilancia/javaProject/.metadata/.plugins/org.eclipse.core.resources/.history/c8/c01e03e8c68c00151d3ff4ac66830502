...
import br.edu.ifba.embarcados.drivervigilancia.javaapp.conector.FabricaConectores;
import br.edu.ifba.embarcados.drivervigilancia.javaapp.conector.IComunicacaoSensores;
